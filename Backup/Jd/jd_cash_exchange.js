...
* @ScriptURL         https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd_cash_exchange.js
* ==/UserScript==
【QuantumultX】 :
*************************
[task_local]
0,1,2 0 * * * https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd_cash_exchange.js, tag=领现金兑换红包
*************************
【Loon】 :
*************************
[Script]
cron "0,1,2 0 * * *" script-path=https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd_cash_exchange.js,tag=领现金兑换红包
*************************
【Surge】 :
*************************
[Script]
领现金兑换红包 = type=cron,cronexp="0,1,2 0 * * *",wake-system=1,timeout=120,script-path=https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd_cash_exchange.js
*************************
【小火箭】 :
*************************
[Script]
领现金兑换红包 = type=cron,script-path=https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd_cash_exchange.js, cronexpr="0,1,2 0 * * *", timeout=500, enable=true
*************************
[mitm]
