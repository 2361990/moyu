...
async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd-live-rain.json`
...
function rraUrl() {
    let url = 'https://gitlab.com/ddgksf2013/Cuttlefish/-/raw/master/Jd/jd-live-rain.json'
